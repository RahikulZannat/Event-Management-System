	...
	<table border="2">
		...
		<tr>
			...
			<td>	<div>  day  &nbsp;  month  &nbsp;&nbsp;&nbsp;  year</div>
				<input id="day" type="number" size="1" name="day" value="" style="width: 3em" onkeyup="DOB()">/ 
				<input id="month" type="number" size="1" name="month" value="" style="width: 3em" onkeyup="DOB()">/
				<input id="year" type="number" size="3" name="year" value="" style="width: 4em" onkeyup="DOB()"> 
			...
			<td>
				...
				<input id="designer" type="checkbox" name="position"value="Designer">Designer
      			<input id="cook" type="checkbox" name="position" value="Cook">Cook
       		    <input id="admin" type="checkbox" name="position" value="Admin">Admin
			</td>
		</tr>
		<tr>
			<td>BG:</td>
