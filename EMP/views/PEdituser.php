...
<body>
	...
	<table>
		...
		<tr>	
			...
			<td align="left">
				<input type="button" onclick="location.href='PhotographerAdmininterface.php';" value="ADD" />
		...
		<tr>	
			...
			<td align="left">
				<input type="button" onclick="location.href='PhotographerAdmininterface.php';" value="Remove" />
